...
namespace UnifiedDevelopmentPlatform.Infraestructure.Domain.Entities.Message.Type
{
    ...
    public enum TypeMetadata : int
    {
        ...
        [Description("Call start to the select parameters the kinds of unifiedDevelopment platform")] CallStartToTheSelectParametersTheKindsOfUnifiedDevelopmentPlatform = 5,
        [Description("Success to the select parameters the kinds of unifiedDevelopment platform")] SuccessToTheSelectParametersTheKindsOfUnifiedDevelopmentPlatform = 6
    }
}