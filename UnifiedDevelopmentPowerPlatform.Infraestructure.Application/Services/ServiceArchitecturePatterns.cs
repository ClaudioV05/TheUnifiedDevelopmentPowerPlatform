...
namespace UnifiedDevelopmentPowerPlatform.Application.Services
{
    ...
    public class ServiceArchitecturePatterns : IServiceArchitecturePatterns
    {
        ...
        {
            _serviceLog.UDPLogReport(_serviceMessage.UDPGetMessage(TypeArchitecturePatterns.CallStartToTheSelectParametersTheKindsOfArchitecturePatterns), _serviceFuncString.Empty);
            ...
            try
            {
                ...
                if (listItems.Any())
                {
                    _serviceLog.UDPLogReport(_serviceMessage.UDPGetMessage(TypeArchitecturePatterns.SuccessToTheSelectParametersTheKindsOfArchitecturePatterns), _serviceFuncString.Empty);
                }
            }
